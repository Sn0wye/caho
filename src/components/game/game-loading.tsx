...
export function GameLoading({}: GameLoadingProps) {
  return (
    <div className="relative flex h-screen w-screen overflow-hidden">
      <section className="z-10 flex flex-1 flex-col items-center justify-center gap-12 bg-linear-to-b from-white/80 from-50% to-white/10 dark:from-zinc-950/90 dark:from-50% dark:to-zinc-950/30">
        <CardsLoader />
