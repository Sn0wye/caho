...
import { signUpRequest, type SignUpRequest } from '@/contracts';
      ...
      <div className="m-0 flex w-auto max-w-none flex-col gap-8 rounded-none bg-white p-0 text-zinc-950 shadow-none dark:bg-zinc-950">
        ...
        <div className="flex gap-2">
          ...
          <a
            ...
            className="focus-visible:ring-ring focus-visible:outline-hidden flex h-10 w-full items-center justify-center rounded-md border border-zinc-200 bg-white px-3 font-medium transition-colors hover:bg-zinc-100 focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50 dark:border-zinc-900 dark:bg-zinc-900/10 dark:hover:bg-zinc-900/80"
          >
