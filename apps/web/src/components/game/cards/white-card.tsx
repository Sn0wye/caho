...
export function WhiteCard({ data }: WhiteCardProps) {
  ...
  return (
    <div className="flex aspect-card h-72 flex-col justify-between gap-2 rounded-xl border border-zinc-950 bg-zinc-50 p-5 transition-all hover:scale-110 dark:border-zinc-50">
